...
type MasterConfiguration struct {
	...
	// ImageRepository指定了从哪个容器registry拉取控制平面的镜像
...
// GetControlPlaneImageRepository返回控制平面的image使用的image repository（包括API, Controller Manager，Scheduler以及Proxy）
// 它会用CI registry进行覆盖，如果用户在CI build area请求特定的Kubernetes版本的话
